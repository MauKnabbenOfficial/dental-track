...
import { MockStorage, simulateDelay, filterByText } from "./mockUtils";

// Storage instances
const templateStorage = new MockStorage<ProcedureTemplate>(
  "dentaltrack_procedureTemplates",
  initialProcedureTemplates
);

const stageStorage = new MockStorage<ProcedureTemplateStage>(
  "dentaltrack_procedureTemplateStages",
  initialProcedureTemplateStages
);
